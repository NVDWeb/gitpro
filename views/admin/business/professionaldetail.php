        ...
        <div class="container">
          <div class="row">
            <div class="explor-profes-list01">
              <h3>Find & get the Job done</h3>
              <div class="explor-profes-list-form">
                <div class="explor-profes-list-form-icon"><i class="fa fa-search" aria-hidden="true"></i></div>
                <input type="text" name="" placeholder="Search professionals by name">
                        ...
                        <div class="x_panel" style="padding-bottom: 0px;">
                          ...
                          <div class="profile_form_update edu_update01">
                          	<div class="profile_team site-header">
                                <div class="col-md-3 col-sm-3 col-xs-12 steky_profile_left">
                              ...
                              <ul>
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12 steky_text1">
                                    <div class="profile_team_box2">
                                        <div class="profile_team_name">
                                            <h2><?php echo $businessDetails[0]->first_name;?> <span><?php if(isset($businessDetails['workexp'])) { echo $businessDetails['workexp'][0]->Title; } else { echo 'No Work Experience';}?></span> <b class="profile_star_rating">Ratings : <i class="fa fa-star"></i><?php if(isset($totalReviews[0]->rating)) { echo $totalReviews[0]->rating;} else{ echo '0';} ?></b></h2>
                                        ...
                                        <div class="profile_mange">
                                          <ul>
                                            <?php                                
                                       $i=0;         
                                        foreach ($businessDetails['skills'] as $ach) {                  
                                        ?>
                                        <li><a href="#" title="<?php echo $ach->ExperienceInMonths;?> Months"><?php echo $ach->skills;?></a></li>
                                          <?php $i++; if($i==3) break;}?>
                                          <li><a href="#"><?php echo count($businessDetails['skills']);?>+</a></li>
                                           
                                          </ul>
                                          <?php if($businessDetails[0]->resume_status==1){ ?><span><img src="<?php echo base_url();?>admin-assets/images/admin_check.jpg" alt="proyourway verfifed"> 100% ProYourWay Verified</span>
                                          <?php }else{ ?>
                                          <span><img src="<?php echo base_url();?>admin-assets/images/admin_uncheck.jpg" alt="proyourway verfifed"> 100% ProYourWay Verified</span>
                                          <?php } ?>
                                        </div>
                                         <?php
                                        $i=1;
                                        //echo '<pre>';print_r($businessDetails['category'][0]->category_name);
                                        ...
                                        if(!empty($businessDetails[0]->country_name)){
                                          $country_name = $businessDetails[0]->country_name;
                                        }else{
                                          $country_name= $country;
                                        }                   
                                        if(!empty($businessDetails[0]->state_name)){
                                          $state_name = $businessDetails[0]->state_name;
                                        }else{
                                          $state_name= $state;
                                        }                   
                                        if(!empty($businessDetails[0]->city_name)){
                                          $city_name = $businessDetails[0]->city_name;
                                        }else{
                                          $city_name= $city;
                                        }  
                                        //print_r($businessDetails);
                                        ?>
                                        <div class="client_view_profile">
                                          <ul>
                                            <li>Category   <span><?php echo $businessDetails['category'][0]->category_name;?></span></li>
                                            <li>No. of Hiring    <span><?php if(isset($businessDetails['totalHiring'])) { echo $businessDetails['totalHiring'][0]->totalHiring; } else { echo 0 ;}?></span></li>
                                            <li>Location    <span><?php echo $city_name.' ,'.$state_name.' ,'.$country_name;?></span></li>
                                          </ul>
                                          <div class="hire_project">
                                             <?php if($this->session->userdata('admin_user_type') == 3){ ?>
                           
                  
                             <?php  echo '<a href="javascript:void();" class="hire_project1" onclick="openPopUp2('.$businessDetails[0]->id.')"><i class="fa fa-user" aria-hidden="true"></i> Hire for project</a>';?>
                  
                  
                             <?php  echo '<a href="javascript:void();" class="hire_project2" onclick="openPopUp3('.$businessDetails[0]->id.')"><i class="fa fa-briefcase" aria-hidden="true"></i> Hire for work</a>';?>
                            <?php  if(empty($checkfavourite)){?>
                             <?php  echo '<a href="javascript:void();" class="hire_fev" onclick="favourite('.$this->session->userdata('adminId').','.$businessDetails[0]->id.')"><i class="fa fa-star" aria-hidden="true"></i></a>';?>
                  <?php }?>
                        ...
                        <div class="col-md-12">
                            <div class="profile_team">
                                <div class="profile_team_exp">
                                    <h2><i class="fa fa-file-text"></i> Objective</h2>
                   ...
                   <?php  if(isset($businessDetails['skills'])){?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="profile_team">
                                <div class="profile_team_exp">
                                    <h2><i class="fa fa-file-text"></i> Tech Stack</h2>
                                   <!-- <h3>Development Tools :</h3>-->                                   
                                    <div class="profile_team_exp_tag">
                                     <?php                                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="profile_team">
                                ...
                                <div class="profile_team_edu" style="padding-top: 20px;">
                                  <div class="unierty_list new_unil">
                                    <div class="unierty_list01"><b>University / College Name</b></div>
                                    <div class="unierty_list02"><b>Course Name</b></div>
                                    <div class="unierty_list03"><b>Years <span>( Ex 2011-2014 )</span></b></div>
                                  </div>
                                  <?php 

                                    foreach ($businessDetails['education'] as $education) {
                                        ?>
                                  <div class="unierty_list">
                                    <div class="unierty_list01"> <?php if(isset($education->school_name)){  echo $education->school_name;} ?></div>
                                    <div class="unierty_list02"><?php if(isset($education->DegreeName)){
                                                echo $education->DegreeName;
                                                }?></div>
                                    <div class="unierty_list03"><?php if(isset($education->startdate)){
                                                echo date("Y",strtotime($education->startdate));
                                                } echo '-'; if(isset($education->endDate)){
                                                echo date("Y",strtotime($education->endDate));
                                                }?></div>
                                  </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="profile_team">
                              <h2 class="h2_head" style="margin-bottom: 20px;"><i class="fa fa-tasks"></i> Projects Overview</h2>
                              <div class="clien_view_project_main">
                                <div class="clien_view_project new_ist">
                                    <div class="clien_view_project01"><b>Project Name</b></div>
                                    <div class="clien_view_project02"><b>Status</b></div>
                                    <div class="clien_view_project03"><b>Reviews <span>( 10 )</span></b></div>                                    
                                  </div>

                                <div class="accordion">
                                  <?php if($projectOverview){ $i=1; foreach ($projectOverview as $key => $value) { ?>
                                    <!-- 1 -->
                                  <div class="accordion__section">
                                      <div class="accordion__titlebox" data-href="#accordion-<?php echo $i;?>">
                                          <div class="accordion__icon">
                                              <span class="plus">+</span>
                                              <span class="minus">—</span>
                                          </div>
                                          <div class="accordion__title">
                                              <div class="clien_view_project">
                                                <div class="clien_view_project01"><?php echo $value->project_name;?></div>
                                                <div class="clien_view_project02">
                                                <?php if($value->project_status==1){
                                                  echo 'Completed';
                                                 } elseif($value->project_status==0){
                                                  echo 'Progress';
                                                 } else{
                                                  echo 'Requested to close';

                                                }?></div>
                                                <div class="clien_view_project03">Reviews <div class="client_view_star"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div></div>
                                              </div>
                                          </div>
                                      </div>

                                      <div id="accordion-<?php echo $i;?>" class="accordion__content">
                                          <p><?php echo $value->work_detail;?></p>
          ...
          <form class="form-horizontal">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <select name="category" id="category" class="" onChange="getSubCategoriesByParentId(this.value);">
                  <option value="0">--Select Category--</option>
                  <?php foreach($categoryList as $row){
                    echo '<option value="'.$row->id.'" '.($category== $row->id ? "selected" : '').'>'.$row->category_name.'</option>';
                  }?>
                </select>
                <span id="errCat" style="color:red;"></span>
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <span id="errSubCat" style="color:red;"></span>
              </div>
            </div>
      ...
      <div class="modal-body">
          ...
          <form class="form-horizontal">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label for="email">Select Category * </label>
                <select name="category" id="catjob" class="" onChange="getSubCategoriesByParentIdJob(this.value);">
                  <option value="0">--Select Category--</option>
                  <?php foreach($categoryList as $row){
                    echo '<option value="'.$row->id.'" '.($category== $row->id ? "selected" : '').'>'.$row->category_name.'</option>';
                  }?>
                </select>
                <span id="errCatJob" style="color:red;"></span>
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label for="email">Select Sub Category * </label>
                <select name="sub_category" class="form-control" id="subcatjob">
                  <option value="0">--Select Sub Category--</option>
                </select>
                <span id="errSubCatJob" style="color:red;"></span>
              </div>
            </div>
...
$(document).ready(function() {
  ...
  $("#save").click(function(){
    ...
    //alert(subcat);
    if(cat==0){
      $("#errCat").html('Please Select Category.');
      error=1;
    }else{
      $("#errCat").html('');
    }
     ...
     if(subcat==0){
      $("#errSubCat").html('Please Select Sub-Category.');
      error=1;
    }else{
      $("#errSubCat").html('');
    }
    ...
    if(error==0){
      ...
      $.ajax({
        ...
        data:{"cat":cat,"subcat":subcat,"pId":pId,"project_name":project_name,"work_detail":work_detail,"type_of_project":type_of_project,"hiretype":hiretype,
  ...
  $("#saveforwork").click(function(){
    //var cat = $("#catjob").val();
    var cat = $("#catjob option:selected").val();
    //var subcat = $("#subcatjob").val();
    var subcat = $("#subcatjob option:selected").val();
    var pId = $("#pidjob").val();
    ...
    var error = 0;
    if(cat==0){
      $("#errCatJob").html('Please Select Category.');
      error=1;
    }else{
      $("#errCatJob").html('');
    }
     ...
     if(subcat==0){
      $("#errSubCatJob").html('Please Select Sub-Category.');
      error=1;
    }else{
      $("#errSubCatJob").html('');
    }
...
function highlightStar(obj,id) {
 ...
 function getSubCategoriesByParentId(categoryId){
  ...
  function getSubCategoriesByParentIdJob(categoryId){
    //alert(categoryId);
    if(categoryId){
      if(categoryId==1){
        $("#software").show();
...
<script src="<?php echo base_url();?>admin-assets/js/ez-accordion.js"></script>

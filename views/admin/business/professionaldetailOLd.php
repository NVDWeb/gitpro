        ...
        <div class="boday_main">
        	<div class="main_container01">
                ...
                <div class="right_col" role="main">
                  <div class="">
                          ...
                          <div class="profile_form_update edu_update01">
                              ...
                              <ul>
                                ...
                                <div id="rev" style="display:none">
                                    ...
                                    <?php if($revs->admin_id){
                                      echo '<h6>Proyourway</h6>';
                                    }else{
                                       echo '<h6>'.$revs->name.'</h6>';
                                    } 
                                    echo '<h5>'.$revs->reviewtext.'</h5>'; 
                   ...
                   <?php  if(isset($businessDetails['skills'])){?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="profile_team">
                            	<h2 class="h2_head"><i class="fa fa-briefcase"></i> Portfolio Highlights</h2>
                  ...
                  <!--  <?php  echo '<a href="javascript:void();" class="btn btn-success" onclick="openPopUp('.$categorys.','.$sub_category.','.$businessDetails[0]->id.')">Hire</a>';?>
         -->
        
                   <?php  echo '<a href="javascript:void();" class="btn btn-success" onclick="openPopUp2('.$categorys.','.$sub_category.','.$businessDetails[0]->id.')">Hire for project</a>';?>
        
        
                   <?php  echo '<a href="javascript:void();" class="btn btn-success" onclick="openPopUp3('.$categorys.','.$sub_category.','.$businessDetails[0]->id.')">Hire for work</a>';?>
                  <?php  if(empty($checkfavourite)){?>
                   <?php  echo '<a href="javascript:void();" class="btn btn-success" onclick="favourite('.$this->session->userdata('adminId').','.$businessDetails[0]->id.')">Favourite</a>';?>
        <?php }?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form class="form-horizontal">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Project Details *  </label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Number of Hours required per week *  </label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Budget Amount * </label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Payment options * </label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Do you want company details to be confidential  </label>
              <div class="col-sm-4">

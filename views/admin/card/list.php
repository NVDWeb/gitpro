              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title page_tit">
                    <h2>Card Details
                     <?php //echo '<pre>'; print_r($cardList);?>
                     <?php if(!empty($cardList[0]->account_type) != 2 && !empty($cardList[0]->created_by) != $this->session->userdata('adminId')){?>
                        <ul class="nav navbar-right panel_toolbox"> <a href="<?php echo base_url();?>admin/account/card/add"> <i class="fa fa-plus-circle"></i> Add Card  </a>
                    <?php }?>
                    </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped">
                      ...
                      <tbody>
                          ...
                          echo '<tr><td>'.($row->card_type==1 ? 'Visa Card' : 'Master Card').'</td>';
                          echo '<td>'.$row->card_holder_name.'</td>';
                          echo '<td>'.$row->card_no.'</td>';
                          echo '<td>'.$row->ccv.'</td>';
                          echo '<td><a href="'.base_url().'admin/account/card/'.$row->id.'" class="tabl_link"><i class="fa fa-edit"></i></a> | <a href="javascript:void(0);" class="delete tabl_link" id="delete_'.$row->id.'" data-id="'.$row->id.'" ><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
                        } ?>
                      </tbody>
                    </table>
                  </div>

              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <li><a href="<?php echo base_url();?>admin/category/add"> <i class="fa fa-plus-circle"></i> Add Category</a></li>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          ...
                          echo '<td><a href="'.base_url().'admin/category/edit/'.$row->id.'"><i class="fa fa-edit"></i></a> | <a href="javascript:void(0);" class="delete" id="delete_'.$row->id.'" data-id="'.$row->id.'" >Delete</a></td></tr>';
                        } ?>

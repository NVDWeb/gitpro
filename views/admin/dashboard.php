                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="dashboard_tabing">
                                    <div id='tabs'>
                                        <ul>
                                            <li>Active projects (<?php echo count($leadsList);?>)</li>
                                            <li>Completed projects (<?php echo count($completelist);?>)</li>
                                            <li>Open Proposals (<?php echo count($acceptedProposal);?>)</li>
                                            <li>Rejected proposals (<?php echo count($rejectedProposal);?>)</li>
                                            <li>Interview Request (<?php echo count($getinterview);?>)</li>
                                        </ul>
                                    ...
                                    <div class="tabs-panel">
                                        ...
                                        <div class="match_pro_list">
                                        <ul>
											<?php  foreach ($acceptedProposal as $row) { //echo '<pre>';print_r($row);	die;						  
												if($row->b_id == $this->session->userdata('adminId')){?>
                                                    <li>
                                                        <div class="mact_lit01 activepro_lsit">
                                                        <div class="row">
                                                        <div class="col-md-12">
                                                        <h3>Proposal Created <?php echo date('d/m/Y',strtotime($row->created_date));?></h3>
                                                        <h4><a href="#"><?php echo $row->project_name;?></a></h4>
                                                        </div>
                                                        </div>
                                                        <div class="row">
                                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <p>Client Name <b><?php echo $row->name;?></b></p>                                                        </div>
                                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <p><?php echo $row->work_detail;?></p>
                                                        <p>
                                                        <a href="<?php echo base_url().'admin/proposal/view/'.$row->id .'/'.$row->verifiedbyadmin;?>">View full details ›</a>
                                                        <?php if($row->verifiedbyadmin == 3){?>
                                                        <a href="<?php echo base_url().'admin/proposal/view/'.$row->id .'/'.$row->verifiedbyadmin;?>"> Requested To Update ›</a> 
                                                          <?php }?>
														</p>
                                    ...
                                    <div class="tabs-panel">
                                        ...
                                        <div class="match_pro_list">
                                        <ul>
											<?php  foreach ($rejectedProposal as $row) { //echo '<pre>';print_r($row);	die;						  
												if($row->b_id == $this->session->userdata('adminId')){?>
                                                    <li>
                                                        <div class="mact_lit01 activepro_lsit">
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                                            <p>Client Name <b><?php echo $row->name;?></b></p>
                                                            <?php if(isset($row->verifiedbyadmin) && $row->verifiedbyadmin == 2){?>
                                                            <p>Proposal Status<b> Rejected</b></p>
                                                            <?php }?>
                                                        </div>
                                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                                            <p><?php echo $row->work_detail;?></p>
                                                            <p><a href="<?php echo base_url().'admin/proposal/view/'.$row->id .'/'.$row->verifiedbyadmin;?>">View full details ›</a></p>
                                                        </div>
                                                        </div>
                                                        </div>
                                                    </li>                            
                                    ...
                                    <div class="tabs-panel">
                                        ...
                                        <div class="match_pro_list">
                                        <ul>
											<?php  foreach ($getinterview as $row) { //echo '<pre>';print_r($row);	die;						  
												if($row->b_id == $this->session->userdata('adminId')){?>
                                                    <li>
                                                        <div class="mact_lit01 activepro_lsit">
                                                        <div class="row">
                                                        <div class="col-md-12">
                                                        <h3>Interview Created Date <?php echo date('d/m/Y',strtotime($row->created_date));?></h3>
                                                        <h4><a href="#"><?php echo $row->project_name;?></a></h4>
                                                        </div>
                                                        </div>
                                                        <div class="row">
                                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                                            <p>Client Name <b><?php echo $row->name;?></b></p>
                                                            <p>Interview Schedule Date <b><?php echo $row->schedule_date_time;?></b></p>
                                                            
                                                        </div>
                                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                                        
                                                        	<?php if($row->interview_accepted==1){
																echo '<p><button class="btn btn-primary btn-xs accept_inter"">Accepted  ›</button></p>';
															}elseif($row->interview_accepted==2){
																echo '<p><button class="btn btn-primary btn-xs accept_inter"">Rejected  ›</button></p>';
															}else{
                                                         
                                                           echo '<p><button class="btn btn-primary btn-xs accept_inter" onclick="accepted('.$row->id.');">Accept Interview Request</button><button class="btn btn-primary btn-xs accept_inter" onclick="rejected('.$row->id.');">Reject Interview Request</button></p>';
															}?>
                                                        </div>
                                                        </div>
                                                        </div>
...
<script>
	function accepted(interviewId){		
	  $.ajax({
      type:"POST",
      url:"<?php echo base_url();?>admin/proposal/acceptInterview",
...
function rejected(interviewId){
	 if (confirm("Are you sure?")) {
		 $.ajax({
            url:"<?php echo base_url();?>admin/proposal/rejectedInterview",
            type: 'post',
            data: {interviewId:interviewId},
            success: function () {
               location.reload();

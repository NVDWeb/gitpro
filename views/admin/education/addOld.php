                            ...
                            echo form_open_multipart($action,$attributes); ?>
                            	...
                            	<div class="row form-group">
                                	<div class="col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <input type="text" id="school_name" name="school_name" placeholder="School/College Name" required class="" value="<?php echo $school_name;?>">
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                    	<label class="" for="first-name">University Location / College Location<span class="required">*</span></label>
                                        <input type="text" id="SchoolLocation" name="SchoolLocation" placeholder="School/College Location" required class="" value="<?php echo $SchoolLocation;?>">
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">

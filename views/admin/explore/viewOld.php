        	...
        	<div class="main_container01">
                ...
                <div class="right_col" role="main">
                  <div class="">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <p>Proposal By : <?php echo $teamData[0]->first_name;?></p>
                   ...
                   <?php  echo '<a href="javascript:void();" class="btn btn-success" onclick="openPopUp('.$category_team.','.$teamData[0]->id.')">Hire</a>';?>
                    <?php }?>
                      </div>
           </div>
       </div>

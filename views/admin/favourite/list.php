                  ...
                  <table id="datatable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        if(!empty($listFavourite)){							
                          foreach ($listFavourite as $row) { 
						 // echo '<pre>';print_r($row);                         
                            echo '<tr><td>'.$row[0]->contact_person_name.'</td>';  
                          	echo '<td><a href="'.base_url().'admin/professionals/index/'.$row[0]->id.'" class="tabl_link"><i class="fa fa-eye"></i> view</a></td> ';
							echo '</tr>';

                  ...
                  <div class="x_content">
                    ...
                    echo form_open_multipart($action,$attributes); ?>                   
                      <div class="row form-group">
                        <div class="col-md-12">
                          <label for="managementSummary">Management Summary</label>
                          <textarea class="form-control" row="3" cols="2" name="managementSummary" placeholder="Management Summary"></textarea>
                        </div>
                      </div>

            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php } else {?>
                    <li><a href="<?php echo base_url();?>admin/milestone/add"> <i class="fa fa-plus-circle"></i> Add Milestone</a></li>
                  <?php } ?>
                      ...
                      foreach ($milestoneList as $row) {
                        ...
                        <?php }else{
                            ...
                            if($row->start_date!='0000-00-00'){
								...
								if($row->id){
									...
									if(!empty($getSplitAmountByMilestoneIds)){
										...
										<?php if($row->status==0 && ($row->milestone_accepted==1 || $row->milestone_accepted_professional==1 )){
												echo '<a href="javascript:void()" onclick="closeMilestone('.$row->id.')" title="Click to Close" class="btn btn-danger">Milestone is Open</a>' ;?>
												<?php if($row->hireda==2 && ($row->milestone_accepted==0 || $row->milestone_accepted==1) ){ ?>
                            <a href="<?php echo base_url();?>admin/milestone/split/<?php echo $row->id;?>" class="btn btn-primary">Add Split Amount</a>
									...
									if($row->hireda==2 && ($row->milestone_accepted==0 || $row->milestone_accepted==1) ){ ?>
                                    	<a href="<?php echo base_url();?>admin/milestone/split/<?php echo $row->id;?>" class="btn btn-primary">Add Split Amount</a>
										<?php }
									}
								}

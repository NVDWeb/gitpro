                          ...
                          <div class="x_content">
                              ...
                              <!-- title row -->
                                ...
                                <?php if($this->session->userdata('admin_user_type')==3){?>
                                  ...
                                  <?php if($paymentDetails){
                                    ...
                                    <tr>
                                      <td><?php echo $value->paidDate;?></td>
                                      <td>Fund Deposited</td>
                                      <td><?php echo $total = (($value->amount*2.75)/100) + $value->amount;?></td>
                                      <td><?php echo $total;?></td>
                                    </tr>
                                    <tr>
                                      <td><?php echo $value->paidDate;?></td>
                                      <td>Paypal Processing Fees (2.75)</td>
                                      <td><?php echo $total1 = $value->amount;?></td>
                              ...
                              <?php if($this->session->userdata('admin_user_type')==2){?>
                                ...
                                <?php if($paymentDetails){
                                  ...
                                  <tr>
                                    <td><?php echo $value->released_date;?></td>
                                    <td>ProYourWay 10% of <?php echo $value->milestone_name;?> Transaction Fee</td>
                                    <td><?php echo $total1 = (($value->amount*10)/100);?></td>
                            ...
                            <?php if($this->session->userdata('admin_user_type')==1){?>
                              ...
                              <?php if($paymentDetails){
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $total = (($value->totalAmount*2.75)/100) + $value->totalAmount;?></td>
                                  <td><?php if($i==0) { echo $total = $total; } else { echo $total = $s+$sum+$total; }?></td>
                                </tr>
                                <tr>
                                  <td>2017-16-09</td>
                                  <td>ProYourWay Service fee of milestone </td>
                                  <td><?php echo $total1 = (($value->totalAmount*10)/100);?></td>
							  ...
							  $withBalance = 0;
							   foreach ($paymentDetails as  $value) {
							    if($withdrawl = $value->withdraw){								
                                  foreach ($withdrawl as $rows) {?>
                                <tr>
                                  <td><?php echo $rows->released_date;?></td>
                                  <td>Withdraw by <?php echo $rows->first_name;?></td>
                                  <td><?php echo $tis = $rows->amount -(($rows->amount*10)/100);?></td>
                                  <td <?php echo $j;?>><?php if($j==0){echo $withBalance = $paidAm-$tis;}else{echo $withBalance = $withBalance-$tis;}?></td>
                                </tr>
                                <?php  }$j++;?>

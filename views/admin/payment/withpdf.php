                        ...
                        <div class="x_panel">
                          ...
                          <div class="x_content">
                            <section class="content invoice">
                              <!-- title row -->
                              <div class="row">
                                <div class="col-xs-12 invoice-header" style="width: 33.3333333333%;">
                                    <h1>
                                    <i class="fa fa-globe"></i> Invoice.
                                    <small class="pull-right">Date: <?php echo date('Y-m-d H:i',strtotime($this->session->userdata('invoiceDate')));?></small>
                                    </h1>
                                </div>
                                <!-- /.col -->
                              </div>
                              ...
                              <div class="row invoice-info">
                                ...
                                <!-- /.col -->
                                <div class="col-sm-4 invoice-col" style="width: 33.3333333333%;">
                                  To
                                  <address>
                                ...
                                <!-- /.col -->
                                <div class="col-sm-4 invoice-col">
                                  <b>Invoice #<?php echo $this->session->userdata('order_id');?></b>
                                  <br>
                                  <br>
                                  <b>Order ID:</b> 4F3S8J
                                  <br>
                              ...
                              <div class="row">
                                <div class="col-xs-12 table">
                                  <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <tr>
                                       <td><?php echo ucfirst($this->session->userdata('payment_type'));?></td>
                                        <td><?php echo $this->session->userdata('category_name');?></td>
                                        <td><?php echo $this->session->userdata('subCategory');?></td>
                                        <td><?php echo $this->session->userdata('order_id');?></td>
                                        <td><?php echo $this->session->userdata('work_detail');?></td>
                                        <td><?php echo $this->session->userdata('amount');?> AUD ($) </td>
                                      </tr>

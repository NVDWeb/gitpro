              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title page_tit">
                    <h2>Your Paypal Account <?php if(!empty($paypalList[0]->account_type) != 1 && !empty($paypalList[0]->created_by) != $this->session->userdata('adminId') ){?> <a href="<?php echo base_url();?>admin/account/paypal/add"> 
                                  <i class="fa fa-plus-circle"></i> Add Paypal Account
                                </a>        
          <?php }?></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <?php //echo '<pre>';print_r($paypalList);
					//echo $paypalList[0]->account_type;
					//echo $paypalList[0]->created_by;
					//print_r($this->session->userdata('adminId'));
                    ...
                    <table id="datatable" class="table table-striped">
                      ...
                      <tbody>
                          ...
                          <?php foreach ($paypalList as $row) {
                          echo '<tr><td>'.$row->paypal_email.'</td>';
                          echo '<td><a href="'.base_url().'admin/account/paypal/'.$row->id.'" class="tabl_link"><i class="fa fa-edit"></i></a>  <a href="javascript:void(0);" class="delete tabl_link" id="delete_'.$row->id.'" data-id="'.$row->id.'" ><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
                        } ?>

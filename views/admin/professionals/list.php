                    ...
                    <tbody>
                        ...
                        if(! empty($professionalsList)){
                          ...
                          //  echo '<td>'.$row->mobile.'</td>';
                            ...
                            echo '<td>'.$sub_cat.'</td>';							
							echo '<td><a href="'.base_url().'admin/professionals/index/'.$row->id.'" class="tabl_link"><i class="fa fa-eye"></i> view</a>
       <a href="javascript:void();" class="btn btn-success" onclick="favourite('.$this->session->userdata('adminId').','.$row->id.')">Favourite</a>
       </td> ';

          ...
          <div class="row">
            <div class="explor-profes-list01">
              ...
              <div class="explor-profes-list-form">
                ...
                <input type="text" id="name" value="" placeholder="Search professionals by name">
              ...
              <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="explore_left_side">
                  <div id="open-by-default-example" data-collapse>
                    ...
                    <div>
                      <ul>
                        <?php $i=1; foreach ($categoryList as $key => $value) { ?>
                          <li>
                            <input type="checkbox" id="test<?php echo $i;?>" class="ipchkCategory" value="<?php echo $value->id;?>" name="sport" onClick="selectCat();"  />

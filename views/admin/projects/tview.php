                  ...
                  <div class="x_content">
                    ...
                    if($bidDetails && $this->session->userdata('adminId')==$bidDetails[0]->business_id){
                      ...
                      <div class="bid_02">
                        ...
                        <?php if($row->status==1){
                          echo '<span style="color:green;"><strong>BID is Closed and </strong></span>';
                           if($this->session->userdata('adminId')==$row->assignedbusiness_id) {
                              echo '<span style="color:green;"><strong>  Assigned to You  </strong> | BID closing amount for this project is $'.$row->bidclosingamount.' (AUD)</span>';
                            }
                          }else{
                            echo 'BID is open';
                          }
                        ...
                        <?php if($milestoneData){ ?>
                          <div class="bid_02">
                             <div class="bid_01_half">Milestone Created</div>
                              <?php  echo '<a href="'.base_url().'admin/milestone/index/'.$row->assignedbusiness_id.'/'.$row->quotation_id.'" class="btn btn-success bid01">Click to view</a>';?>
                          </div>
                        <?php } ?>
                        ...
                        <div class="bid_02">
                           <div class="bid_01_half">Start Your Project</div>
                             ...
                             <?php if($row->assignTeam==0){ ?>
                              You can start your project with your Team or Individually as freelancer | click <a href='<?php echo base_url();?>admin/projects/assignteam/<?php echo $row->quotation_id;?>' onClick="checkAndAssignTeam(<?php echo $row->quotation_id;?>)" class="btn btn-default bid01">here</a> to start with your team
                             <?php }else{ ?>
                    ...
                    ?>
                     ...
                     ?>
                        ...
                        Consumer Name : <?php if($leadDetail[0]->confedential==1) { echo 'Confedential' ; } else { echo $leadDetail[0]->name; } ?><br/>
                        ...
                        <?php
                        if(@$leadDetail['proposal'][0]->proposal_accepted==0){ ?>
                          <button class="btn btn-primary btn-xs" onClick="postProposal(<?php echo $leadDetail[0]->id;?>);"><strong>Send Proposal</strong></button>
                      <?php }else{ ?>
                      ...
                      <?php } ?>
                        ...
                        <?php if($leadDetail['interview']){

                          foreach ($leadDetail['interview'] as $rows) { ?>
                            <div class="bid_02">
                               <div class="bid_01_half">Interview Details</div>
                                  <?php echo 'Interview Date/Time : '.$rows->schedule_date_time; ?> (SYDNEY TIME)
                            </div>
                          <?php  if($rows->interviewBusinessId==$this->session->userdata('adminId') && $rows->interview_accepted==0){?>
                              <br/>
                              <button class="btn btn-primary btn-xs" onClick="acceptInterview(<?php echo $rows->interviewId;?>);"><strong>Accept Interview Request</strong></button>
                            <?php }else{
                              echo '<span style="color:green">Interview Accepted by You.</span>';
                            }
                          }
                        }else{ ?>
                          <span style="color:red">No Interview Scheduled</span>
                      <?php   } ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
              <input type="text" class="form-control" name="proposalprojectname" id="proposalprojectname">
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Project Overview : </label>
              <div class="col-sm-4">
                <textarea class="form-control" id="proposaloverview"></textarea>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Project Summary : </label>
              <div class="col-sm-4">
                <textarea class="form-control" id="proposalsummary"></textarea>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Project Activities : </label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Time frame : </label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Project fee (AUD) : </label>
              <div class="col-sm-4">
                <input type="text" class="form-control numeric" name="proposalfee" id="proposalfee" >
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-4" for="email">Additional Details  : </label>
              <div class="col-sm-4">
                <textarea class="form-control" id="proposaladditionaldetails"></textarea>
              </div>
            </div>
      ...
      <div class="modal-footer" style="text-align: center;">
        ...
        <button type="button" class="btn btn-default" id="closePostProposal">Close</button>
        <button type="button" class="btn btn-primary" id="savePostProposal">Send Proposal</button>
      </div>

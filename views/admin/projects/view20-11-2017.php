                ...
                echo '<a href="'.base_url().'admin/milestone/view/'.$row->assignedbusiness_id.'/'.$row->quotation_id.'" class="btn btn-primary">Create Milestone</a>';
                      ...
                      <?php if($row->bidcount < 3){?>
                       ...
                       <?php } ?>
                        ...
                        <?php } ?>
                        <?php //echo '<pre>'; print_r($leadDetail);?>
...
//                            }
              ?>
                        ...
                        <div class="bid_01">
                          <div class="bid_01_half">Work Details </div> <div class="work_div_detail"><?php echo $leadDetail[0]->work_detail;?></div></div>
                        <div class="bid_01">
            ...
            ?>
                  ...
                  foreach ($proposalData as $rows) {  
                    if($this->session->userdata('adminId')==$rows->proposalBusinessId){
                          ...
                          <?php }elseif($rows->proposal_accepted==3){?>                             
                              ...
                              <a href="<?php echo base_url();?>admin/milestone/view/<?php echo $leadDetail[0]->assignedbusiness_id;?>/<?php echo $leadDetail[0]->id;?>" class="btn btn-primary">Create Milestone</a>
                            </div>
               ...
               <?php } else{ ?>
                      ...
                      <?php } } }}else{?>                     
                            <div class="bid_02">
                                <div class="bid_01_half"><button class="btn btn-primary btn-xs bid02" onClick="postProposal(<?php echo $leadDetail[0]->id;?>);"><strong>Send Proposal</strong></button>
                                    </div>
                        </div>
                      <?php }?>
                    <?php }?>

                ...
                <div class="containernew">
                  ...
                  <div class="row">
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <div class="project_view_left">
                        <div class="project_view_ul">
                          <ul>
                            <li><span>Project posted</span><?php echo date('d M Y h:i',strtotime($leadDetail[0]->created_date));?></li>
                    ...
                    if($bidDetails && $this->session->userdata('adminId')==$bidDetails[0]->business_id){                  
                      ...
                      <div class="bid_01 ne-project-view"><div class="bid_01_half"><label>Job From  </label></div>

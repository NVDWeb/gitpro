                        ...
                        <?php if($row->status==1){
                          echo '<span style="color:#565555;">BID is Closed & </span> ';
                           if($this->session->userdata('adminId')==$row->assignedbusiness_id) {
							  ...
							  echo '<a href="'.base_url().'admin/milestone/view/'.$row->assignedbusiness_id.'/'.$row->quotation_id.'" class="btn btn-primary">Create Milestone</a>';
                            }
                          }else{
                            echo 'BID is open';
                          }
...
//                            }
                      ...
                      <?php 
                      if($leadDetail['interview']  ){

                          foreach ($leadDetail['interview'] as $rows) {
                            if($rows->interviewBusinessId==$this->session->userdata('adminId')){
                           ?>
                      ...
                      <?php   } ?>
                       ...
                       <?php
                      if(!empty($leadDetail['proposal'])){
                        foreach ($leadDetail['proposal'] as $rows) {

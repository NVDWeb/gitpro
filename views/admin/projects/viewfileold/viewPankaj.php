                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    if($bidDetails && $this->session->userdata('adminId')==$bidDetails[0]->business_id){
                      ...
                      {?>
                      <div class="bid_01"><div class="bid_01_half"><label>Job From  </label></div>
                        ...
                        <?php if($row->status==1){
                          echo '<span style="color:#565555;">BID is Closed & </span> ';
                           if($this->session->userdata('adminId')==$row->assignedbusiness_id) {
                              echo '<span style="color:#565555;">Assigned to You   | BID closing amount for this project is <strong class="bid_close_amount">  $'.$row->bidclosingamount.' (AUD)</strong></span>';
                            }
                          }else{
                            echo 'BID is open';
                          }
                    ...
                    if($messageThread){
                      foreach($messageThread as $mess){
						  ...
						  //$dat = date_create($mess->created_date);
                    ...
                    ?>
                     ...
                     <?php if($this->session->userdata('admin_user_type')==2){?>
                      <button data-toggle="modal" class="send_mesg_bider_chat" onClick="sendMessage(<?php echo $row->quotation_id;?>,<?php echo $row->business_id;?>);">SEND MESSAGE</button>
                      <?php } ?>
                      </div>
                      <hr>
                     <?php
                     ...
                     ?>
                        ...
                        <?php 
						//if($leadDetail[0]->assignedbusiness_id==$this->session->userdata('adminId')){
//                              echo '<strong>Client hired you for this job Please BID Your amount.</strong><br>';
//                          }
						  ?>
                          <?php 
						 // if($leadDetail[0]->assignedbusiness_id==$this->session->userdata('adminId') && $leadDetail[0]->bidamounthire!=0){
//                                echo '<strong>Client\'s BID Amount for the project is '.$leadDetail[0]->bidamounthire.' AUD.</strong><br>';
//                            }
							?>

                        <div class="bid_01">
                        	<div class="bid_01_half">Work Details </div> <?php echo $leadDetail[0]->work_detail;?></div>
                        <div class="bid_01">
                        	<div class="bid_01_half">Proposal Amount by client </div> <?php echo '$'. $leadDetail[0]->bidamounthire;?> (AUD)</div>
                      ...
                      <?php if($leadDetail['interview']){
                          ...
                          <?php  if($rows->interviewBusinessId==$this->session->userdata('adminId') && $rows->interview_accepted==0){?>
                              ...
                              <button class="btn btn-primary btn-xs accept_inter" onClick="acceptInterview(<?php echo $rows->interviewId;?>);">Accept Interview Request</button>
                            <?php }else{
                              echo '<span class="interview_accepted">Interview Accepted by You.</span>';
                            }
                          }
                        }else{ ?>
                          <span style="color:#615f5f">No Interview Scheduled</span>
                      ...
                      <?php   } ?>
					   ...
					   //echo '<pre>';print_r($leadDetail);
                        ...
                        <div class="bid_02">
                            <div class="bid_01_half"><button class="btn btn-primary btn-xs bid02" onClick="postProposal(<?php echo $leadDetail[0]->id;?>);"><strong>Send Proposal</strong></button></div>
                          </div>
                          
                      <?php }elseif($leadDetail['proposal'][0]->proposal_accepted==2){?>
						  	
                            <div class="bid_02">
                        <div class="bid_01_half">Proposal Status</div><button class="profile_rejected"><span class="">Rejected</span></button>
                        </div>
                         <?php }elseif($leadDetail['proposal'][0]->proposal_accepted==3){?>                         		
                                <div class="bid_02">

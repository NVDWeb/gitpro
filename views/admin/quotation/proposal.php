                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <?php //echo '<pre>';print_r($proposalData);?>
                             <?php if(!empty($proposalData[0]->first_name)){ ?>
                            <div class="bid_01">
                              <div class="bid_01_half">Proposal By</div> <?php echo $proposalData[0]->first_name;?> | <a href="<?php echo base_url();?>admin/professionals/index/<?php echo $proposalData[0]->b_id;?>" title="View Profile" target="_blank"><button class="btn btn-primary">View Profile</button></a>
                            </div>
                            <?php  }?>
                          <?php if(!empty($proposalData[0]->teamId)){ ?>
                            <div class="bid_01">
                              <div class="bid_01_half">Team name</div> <?php echo $proposalData[0]->team_name;?>
                            </div>
                          <?php  }?>
                           <?php if(!empty($proposalData[0]->proposaloverview)){ ?>
                          <div class="bid_01">
                             <div class="bid_01_half">Proposal Overview</div> <?php echo $proposalData[0]->proposaloverview;?>
                          </div>
                          <?php  }?>
                           <?php if(!empty($proposalData[0]->proposal_text)){ ?>
                          <div class="bid_01">
                             <div class="bid_01_half">Proposal Summary</div> <?php echo $proposalData[0]->proposal_text;?>
                          </div>
                          <?php  }?>
                           <?php if(!empty($proposalData[0]->proposalscopeofwork)){ ?>
                          <div class="bid_01">
                             <div class="bid_01_half">Proposal Scope of work</div> <?php echo $proposalData[0]->proposalscopeofwork;?>
                          </div>
                          <?php  }?>
                           <?php if(!empty($proposalData[0]->proposaltime)){ ?>
                          <div class="bid_01">
                             <div class="bid_01_half">Proposal Time Limit</div> <?php echo $proposalData[0]->proposaltimelimit .' '. ucfirst($proposalData[0]->proposaltime);?>
                          </div>
                          <?php  }?>
                           <?php if(!empty($proposalData[0]->proposaladditionaldetails)){ ?>
                          <div class="bid_01">
                             <div class="bid_01_half">Proposal Additional details</div> <?php echo $proposalData[0]->proposaladditionaldetails;?>
                          </div>
                          <?php  }?>
                           <?php if(!empty($proposalData[0]->proposalfee)){ ?>
                          <div class="bid_01">
                             <div class="bid_01_half">Proposed Fee</div> <?php echo $proposalData[0]->proposalfee;?>
                          </div>
							<?php  }?>
						 <?php if($this->session->userdata('admin_user_type')==1){?>
                            <?php if($proposalData[0]->verifiedbyadmin==1){?>
                                <button class="btn btn-primary">Verified</button>
                            <?php }elseif($proposalData[0]->verifiedbyadmin==2){
								echo '<button class="btn btn-primary">Rejected</button>';								
							}elseif($proposalData[0]->verifiedbyadmin==3){?>
								<button class="btn btn-primary" onClick="proverified(<?php echo $proposalData[0]->id;?>)">Verify</button>
								<button class="btn btn-danger" onClick="prorejected(<?php echo $proposalData[0]->id;?>,'2')">Reject</button>
							<?php }else {?>
                                <button class="btn btn-primary" onClick="proverified(<?php echo $proposalData[0]->id;?>)">Verify</button>
                                <button class="btn btn-danger" onClick="prorejected(<?php echo $proposalData[0]->id;?>,'2')">Reject</button>
                                <button class="btn btn-danger" onClick="prorejected(<?php echo $proposalData[0]->id;?>,'3')">Request To Update</button>
                            <?php }?> 
                         <?php }?>
                            <?php if($this->session->userdata('admin_user_type')!=1){?>
                          <div class="bid_01">
                             <div class="bid_01_half">Interview Detail</div>
               <?php if($proposalData[0]->proposal_accepted==0 || $proposalData[0]->proposal_accepted==2 || $proposalData[0]->proposal_accepted==1){ 
                        if(!empty($interviewData[0]->interview_accepted)==0 && !empty($interviewData[0]->b_id) == $proposalData[0]->b_id){
                            echo 'Interview has Scheduled but not Accepted by Professional';
                        }elseif(!empty($interviewData[0]->interview_accepted)==1 && (!empty($interviewData[0]->b_id)== $proposalData[0]->b_id)){ echo 'Interview has Scheduled and Accepted by Professional';
                        }else{?>
                        ...
                        <?php } 
                     }else{ echo 'No data available for interview';} ?>
                          </div>

                          <div class="bid_01">
                             <div class="bid_01_half">Proposal Status</div>
                             <?php if($proposalData[0]->proposal_accepted==2){?>
                            <button class="proposal_reject">Rejected</button>
                          <?php }else {?>

                            <?php 
                            if($proposalData[0]->bidclosingamount!=0 && ($proposalData[0]->assignedbusiness_id!=$proposalData[0]->b_id)){
                              echo 'Project has assigned to some other professional.'; 

                            }else if($proposalData[0]->proposal_accepted==0){ ?>
                          <button class="btn btn-primary" onClick="showInterest(<?php echo $proposalData[0]->id;?>,<?php echo $proposalData[0]->b_id;?>,<?php echo $proposalData[0]->q_id;?>,<?php echo $proposalData[0]->proposalfee;?>)">Accept Proposal</button>
                          <button class="bargening_btn" onClick="bargening(<?php echo $proposalData[0]->id;?>,<?php echo $proposalData[0]->b_id;?>)">Bargening</button>
                          <button class="proposal_reject" onClick="reject(<?php echo $proposalData[0]->id;?>,<?php echo $proposalData[0]->b_id;?>)">Reject</button>
              <?php }else{
                    if($proposalData[0]->proposal_accepted==1){
                    echo '<strog><span >You have requested to bargening.</span></strong>';?>
                ...
                //echo '<br> <a href="'.base_url().'admin/milestone/view/'.$proposalData[0]->assignedbusiness_id.'/'.$proposalData[0]->q_id.'" class="btn btn-primary">Create Milestone</a>';
                       ...
                       <?php 
             if($bidDetails && ($proposalData[0]->assignTeam==0 && $proposalData[0]->assignedbusiness_id==0)){ 
                        echo '<div class="bid_01"> <div class="bid_01_half">';
                            echo 'Bidding Amount';?>
                            </div>
                            <?php if($bidDetails[0]->bidamount){
								$i=1;
							}
							if($bidDetails[0]->updatebidamount){
								$i=2;
							}
							
							if($bidDetails[0]->updatebidamountsecond){
								$i=3;
							}
							echo '<input type="hidden" id="countBid" value="'.$i.'">';
							?>
                         <?php if($bidDetails[0]->bidamount && $proposalData[0]->b_id == $bidDetails[0]->business_id ){							  
              echo '<button class="bid_amount" onclick="closeBid('.$proposalData[0]->b_id.','.$proposalData[0]->q_id.','.$bidDetails[0]->bidamount.',1,'.$proposalData[0]->teamId.')">  '.$bidDetails[0]->bidamount.' AUD ($)</button>';
                          } ?>
                            <?php if($bidDetails[0]->updatebidamount && $proposalData[0]->b_id == $bidDetails[0]->business_id){
                              echo '<button class="bid_amount " onclick="closeBid('.$proposalData[0]->b_id.','.$proposalData[0]->q_id.','.$bidDetails[0]->updatebidamount.',1,'.$proposalData[0]->teamId.')">  '.$bidDetails[0]->updatebidamount.' AUD ($)</button>'; } ?>

                            <?php if($bidDetails[0]->updatebidamountsecond && $proposalData[0]->b_id == $bidDetails[0]->business_id){
                              echo '<button class="bid_amount " onclick="closeBid('.$proposalData[0]->b_id.','.$proposalData[0]->q_id.','.$bidDetails[0]->updatebidamountsecond.',1,'.$proposalData[0]->teamId.')">  '.$bidDetails[0]->updatebidamountsecond.' AUD ($)</button>';
                            }
                            echo '</div>';


                          }else{
                            echo '<div class="bid_01"> <div class="bid_01_half">BID Status</div>';

                            //if(!empty($proposalData[0]->bidclosingamount)){
//                              echo 'The BID is assign to this '.($proposalData[0]->assignTeam==1 ? 'Team' : 'Professional').' and closing BID Amount is <button class="bid_amount">'.@$proposalData[0]->bidclosingamount.' AUD ($) </button>';
//                              echo '<a href="'.base_url().'admin/milestone/view/'.$proposalData[0]->assignedbusiness_id.'/'.$proposalData[0]->q_id.'" class="place_another_bid_amount">Create Milestone</a>';
//                            }
              if($proposalData[0]->bidclosingamount!=0 && ($proposalData[0]->assignedbusiness_id==$proposalData[0]->b_id)){
              echo 'The BID is assign to this '.($proposalData[0]->assignTeam==1 ? 'Team' : 'Professional').' and closing BID Amount is <button class="bid_amount">'.@$proposalData[0]->bidclosingamount.' AUD ($) </button>';
              echo '<a href="'.base_url().'admin/milestone/view/'.$proposalData[0]->assignedbusiness_id.'/'.$proposalData[0]->q_id.'" class="place_another_bid_amount">Create Milestone</a>';

              echo '<a href="'.base_url().'admin/document/create/'.$proposalData[0]->assignedbusiness_id.'/'.$proposalData[0]->q_id.'" class="place_another_bid_amount">Create Legal Document</a>';


              }else if($proposalData[0]->bidclosingamount==0 && $proposalData[0]->proposal_accepted==1){
                echo 'Waiting for bidding';
              }else if($proposalData[0]->bidclosingamount==0 && $proposalData[0]->proposal_accepted==0){
                echo '<strong>No action has taken yet.Please take some action on proposal for proceed.</strong>';
              }else{
              echo 'Project has assigned to some other professional.';
              }            
                            echo '</div>'; 
          ...
          $i++;
           ...
           <?php }?>
                     ...
                     <div><button data-toggle="modal" class="send_mesg_bider_chat" onClick="sendMessage(<?php echo $q_id;?>,<?php echo $b_id;?>);">SEND MESSAGE</button></div>
                     </div>
                      <?php } ?>
                      <hr>
                            ...
                            <div class="modal-dialog modal-md">
                              <div class="modal-content">
                                ...
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="myModalLabel">Assign or Request to BID again</h4>
                                ...
                                <span class="errorNumeric" style="color: Red; display: none">* Input digits (0 - 9)</span>
                                    ...
                                    <form class="form-horizontal" >
                                      ...
                                      <div class="form_pop">
                                        <div class="form-group">
                                          <div class="col-md-12">
                                            <div class="pop_note"><b>Note :</b>  Assign Project means you are going to assign that project to the professional at this amount.You can request to another BID Amount by clicking on BID Again button.</div></div>
                                          <label class="col-sm-12" for="email">Total Amount to pay : </label>
                                          <div class="col-sm-12">
                                ...
                                <div id="loading" style="display: none;">
                                  ...
                                  <!--<button type="button" class="pop_close" id="closeBid1"><i class="fa fa-times" aria-hidden="true"></i> Close</button>-->
                                  <button type="button" class="pop_submit" id="saveCloseBid"><i class="fa fa-check" aria-hidden="true"></i> Assign Project</button>
                                  <button type="button" class="pop_bid" id="bidagain"><i class="fa fa-refresh" aria-hidden="true"></i> BID Again</button>
                                </div>
...
<div class="modal fade bs-example-modal-lgReject" tabindex="-1" role="dialog" aria-hidden="true">
 ...
 <!--Verify Modol Popup start-->
	<div class="modal fade bs-example-modal-lgProVerify" tabindex="-1" role="dialog" aria-hidden="true">
  	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
      <span class="errorNumeric" style="color: Red; display: none">* Input digits (0 - 9)</span>
      <span id="errProVerify" style="color: red;"></span>
      <span id="sucProVerify" style="color: green;"></span>
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
          	<!--<input type="text" name="shortnote" id="shortnote"/> -->
            <textarea name="proshortnote" id="proshortnote" ></textarea>           
          </div>
        </div>        
      </form>
      </div>
      ...
      <button type="button" class="btn btn-danger" id="proverify">Verify</button>
      </div>
...
<!--Verify Modol Popup End-->
	...
	<div class="modal fade bs-example-modal-lgProReject" tabindex="-1" role="dialog" aria-hidden="true">
  	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      <button type="button" class="close" id="closeProReject"><span aria-hidden="true">×</span></button>
      <h4 class="modal-title" id="myModalLabel">Reject Proposal</h4>
      </div>
      <div class="modal-body">
      <span class="errorNumeric" style="color: Red; display: none">* Input digits (0 - 9)</span>
      <span id="errProReject" style="color: red;"></span>
      <span id="sucProReject" style="color: green;"></span>
      <form class="form-horizontal">
        <input type="hidden" id="proposalRId" name="proposalRId" value="">
        <input type="hidden" id="status123" name="status123" value="">        
        <div class="form-group">
          <label class="control-label col-sm-4" for="email">Short Note : </label>
          <div class="col-sm-4">
          	<!--<input type="text" name="shortnote" id="shortnote"/> -->
            <textarea name="prorejectshortnote" id="prorejectshortnote" ></textarea>           
          </div>
        </div>        
      </form>
      </div>
      <div class="modal-footer" style="text-align: center;">
      <button type="button" class="btn btn-default" id="closeProReject1">Close</button>
      <button type="button" class="btn btn-danger" id="proreject">Reject</button>
      </div>
...
function proverified(proposalId){ 
  $("#proposalId").val(proposalId); 
  $(".bs-example-modal-lgProVerify").modal();
}
$("#closeV").click(function() {   
  $("#proposal_id").val(''); 
  $(".bs-example-modal-lgProVerify").modal('hide');
});
...
$("#proverify").click(function(){		
  var proposalId = $("#proposalId").val();  
   var proshortnote =   $("#proshortnote").val(); 
        //alert(proposalId);alert(proshortnote); 
  $.ajax({
    type:"POST",
    url: "<?php echo base_url();?>admin/quotation/proposalVerifiedbyAdmin",
    data: {proposalId:proposalId,proshortnote:proshortnote},	
    success: function(data) {
		//alert(data);
      if (data=='success'){
        $("#sucProVerify").html('Proposal Verified.');
        setTimeout(function(){$('#suc').html(''); window.location.href = "<?php echo base_url();?>admin/quotation";}, 4000);
      }else{
        $("#errProVerify").html('Sorry something went wrong.');
...
function prorejected(proposalRId,status){
	//alert(status);   
  $("#proposalRId").val(proposalRId);
   $("#status123").val(status);   
  $(".bs-example-modal-lgProReject").modal();
}
$("#closeProReject").click(function() {   
  $("#proposalR_id").val('');  
  $(".bs-example-modal-lgProReject").modal('hide');
});

$("#closeProReject1").click(function() {
   $("#proposalR_id").val('');   
  $(".bs-example-modal-lgProReject").modal('hide');
});

$("#proreject").click(function(){		
  var proposalRId = $("#proposalRId").val();  
  var prorejectshortnote =   $("#prorejectshortnote").val();
  var proposalstatus =   $("#status123").val();   
   //alert(proposalRId);alert(prorejectshortnote); 
  $.ajax({
    type:"POST",
    url: "<?php echo base_url();?>admin/quotation/proposalRejectbyAdmin",
    data: {proposalRId:proposalRId,prorejectshortnote:prorejectshortnote,proposalstatus:proposalstatus},	
    success: function(data) {
		//alert(data);
      if (data=='rejected'){
        $("#sucProReject").html('Proposal Rejected.');
        setTimeout(function(){$('#suc').html(''); window.location.href = "<?php echo base_url();?>admin/quotation";}, 4000);
      }else if (data=='updated'){
		   $("#sucProReject").html('Request to Update Proposal');
        setTimeout(function(){$('#suc').html(''); window.location.href = "<?php echo base_url();?>admin/quotation";}, 4000);
		  }else{
        $("#errProReject").html('Sorry something went wrong.');
        setTimeout(function(){$('#err').html(''); location.reload();}, 4000);
      }
    }
  });
    ...
    var amount =  $("#bidCloseAmount").val();
      ...
      $.ajax({
        ...
        success:function(data){
          $("#loading").hide();
          if (data=='success'){
            $("#sucBid").html('Congratulation! a mail to the professional has sent to BID Again');
            setTimeout(function(){$('#sucBid').html(''); location.reload();}, 4000);
          }else{
            $("#errBid").html('Something went wrong.');
            setTimeout(function(){$('#errBid').html(''); location.reload();}, 4000);
          }
        }
      });

        ...
        <div class="boday_main">
          ...
          //echo '<pre>';print_r($row);
                                  ...
                                  echo '<td>'.date('Y-m-d',strtotime($row->created_date)).'</td>';                               
									...
									<?php }elseif($row->project_status ==2 && ($row->proposal_accepted ==1 || $row->proposal_accepted ==3) && $row->businessId == $row->assignedbusiness_id){?>										
									<td>
                  ...
                  <option value="0">Select to Cancel</option>                                   
									...
									<?php }elseif($row->project_status ==1 && ($row->proposal_accepted ==1 || $row->proposal_accepted ==3) && $row->businessId == $row->assignedbusiness_id){
                  ...
                  }elseif($row->project_status ==0 && ($row->proposal_accepted ==3 || $row->proposal_accepted ==1)  && $row->businessId != $row->assignedbusiness_id){
                    echo '<td><button data-toggle="modal" class="send_mesg_bider_chat" >Not accepted and Assign to other</button></td>';
								   ...
								   if($this->session->userdata('admin_user_type') ==1){
									   ...
									   }elseif($row->verifiedbyadmin ==3){
										     echo '<a href="#" class="tabl_link"><i class="fa fa-eye"></i>Request To Update</a>';	
									   }
									  }
								  echo '</td>';
                                  echo '</tr>';
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" id="projectclose"><span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-footer" style="text-align: center;">
        <button type="button" class="btn btn-default" id="projectclose1">Close</button>

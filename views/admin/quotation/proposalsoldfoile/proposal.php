        	...
        	<div class="main_container01">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <?php //echo '<pre>';print_r($interviewData);?>
                          	 <?php if(!empty($proposalData[0]->first_name)){ ?>
                            <div class="bid_01">
                              <div class="bid_01_half">Proposal By</div> <?php echo $proposalData[0]->first_name;?>
                            </div>
                            <?php  }?>
              ...
              <?php }else{
                ...
                //echo '<br> <a href="'.base_url().'admin/milestone/view/'.$proposalData[0]->assignedbusiness_id.'/'.$proposalData[0]->q_id.'" class="btn btn-primary">Create Milestone</a>';
                       ...
                       <?php 
                       echo '<pre>';print_r($proposalData);
                       if($proposalData['bid'] && ($proposalData[0]->assignTeam==0 && $proposalData[0]->assignedbusiness_id==0)){ 
                        echo '<div class="bid_01"> <div class="bid_01_half">';
                            echo 'Bidding Amount';?>
                            </div>
                            <?php if($proposalData['bid'][0]->bidamount){ echo '

                            <button class="bid_amount" onclick="closeBid('.$proposalData[0]->b_id.','.$proposalData[0]->q_id.','.$proposalData['bid'][0]->bidamount.',1,'.$proposalData[0]->teamId.')">  '.$proposalData['bid'][0]->bidamount.' AUD ($)</button>';
                          } ?>


                            <?php if($proposalData['bid'][0]->updatebidamount){
                              echo '<button class="bid_amount " onclick="closeBid('.$proposalData[0]->b_id.','.$proposalData[0]->q_id.','.$proposalData['bid'][0]->updatebidamount.',1,'.$proposalData[0]->teamId.')">  '.$proposalData['bid'][0]->updatebidamount.' AUD ($)</button>'; } ?>

                            <?php if($proposalData['bid'][0]->updatebidamountsecond){
                              echo '<button class="bid_amount " onclick="closeBid('.$proposalData[0]->b_id.','.$proposalData[0]->q_id.','.$proposalData['bid'][0]->updatebidamountsecond.',1,'.$proposalData[0]->teamId.')">  '.$proposalData['bid'][0]->updatebidamountsecond.' AUD ($)</button>';
                            }
...
//                            }
							if(!empty($proposalData[0]->bidclosingamount) && ($proposalData[0]->assignedbusiness_id==$proposalData[0]->b_id)){
							echo 'The BID is assign to this '.($proposalData[0]->assignTeam==1 ? 'Team' : 'Professional').' and closing BID Amount is <button class="bid_amount">'.@$proposalData[0]->bidclosingamount.' AUD ($) </button>';
							echo '<a href="'.base_url().'admin/milestone/view/'.$proposalData[0]->assignedbusiness_id.'/'.$proposalData[0]->q_id.'" class="place_another_bid_amount">Create Milestone</a>';
							}else{
							echo 'Project has assign to some other professional.';
							}							
                            echo '</div>'; 
                          }?>

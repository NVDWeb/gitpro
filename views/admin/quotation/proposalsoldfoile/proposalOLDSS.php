                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <div class="bid_01">
                             <div class="bid_01_half">Interview Detail</div> <?php if($proposalData[0]->proposal_accepted==0 || $proposalData[0]->proposal_accepted==0 || $proposalData[0]->proposal_accepted==1){ 
                        ...
                        }elseif($interviewData[0]->interview_accepted==1 && ($interviewData[0]->b_id== $proposalData[0]->b_id)){ echo 'Interview has Scheduled and Accepted by Professional';
                        }else{?>

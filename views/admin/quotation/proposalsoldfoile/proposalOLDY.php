                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <?php //echo '<pre>'; print_r($proposalData);?>
                          <?php if($proposalData[0]->proposal_accepted==0){ ?><button class="btn btn-primary" onClick="showInterest(<?php echo $proposalData[0]->id;?>,<?php echo $proposalData[0]->b_id;?>)">Show Interest</button><?php }else{ echo '<strog><span style="color:green">Your Interest is already shown to the Professional.</span></strong>';} ?>
                          ...
                          <?php } elseif($interviewData[0]->interview_accepted==0){
                            echo 'Interview has Scheduled but not Accepted by Professional';
                          }else{ 'Interview has Scheduled and Accepted by Professional';}?>
                          <?php if($proposalData['bid'] && ($proposalData[0]->assignTeam==0 && $proposalData[0]->assignedbusiness_id==0)){
                            ...
                            if(isset($proposalData[0]->bidclosingamount)){
					 ...
					 if($bidDetails){
                      ...
                      <div class="clearfix"></div>
							 ...
							 <?php $messageThread = $this->quotation_model->messageThread($row->quotation_id,$row->business_id);
...
function showInterest(proposalId,b_id){
  if(proposalId){
    $.ajax({
      type:"POST",

      ...
      <div class="main_container">      
        ...
        <div class="pro_dashboard">
               ...
               <?php if(isset($adminData[0]->businessLogo) && $adminData[0]->businessLogo!=''){ ?>
                        ...
                        <?php }else if(isset($adminData[0]->picture) && $adminData[0]->picture!=''){ ?>
            ...
            <?php } ?>
                ...
                <?php if(isset($adminData[0]->business_name)==''){ echo $adminData[0]->business_name; }else{
                  ...
                  ?>
                                      <ul>
                                          <?php if($adminData[0]->totalHiring!=0){ ?>
                                            <li><i class="fa fa-users"></i> No of Hiring   <span>
                                              <?php echo sprintf("%02d", $adminData[0]->totalHiring); ?></span></li>
                                            <?php } ?>
                                    ...
                                    <div class="admin_half_right">
                                      <ul>
                                        ...
                                        <?php }?>
                                          ...
                                          <?php }else{ ?><button><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-half-o"></i> <i class="fa fa-star-o" ></i>  <!--<i class="fa fa-star" aria-hidden="true"></i> 4.5</button></li>--><?php } ?>
                                        </ul>
                                    </div>
                                </div>
                            </div>
           ...
           <div class="profile_form_update">
                      <div class="row form-group">
                          <?php /*?><div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <label class="" for="first-name">Your Name</label>
                                ...
                                <input type="text" id="contact_person_name" name="contact_person_name" class="form-control col-xs-12" value="<?php echo $adminData[0]->contact_person_name;?>" >
                                <span style="color:red"><?php echo form_error('contact_person_name');?></span>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <label class="" for="first-name">Mobile</label>
                              <div class="text_box_icon"><i class="fa fa-mobile" aria-hidden="true"></i></div>
                              <input type="text" id="mobile" name="mobile"  class="form-control col-xs-12" value="<?php echo $adminData[0]->mobile;?>" >
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <label class="" for="first-name">Upload Profile Picture (PNG,JPEG,JPG)</label>
                                    ...
                                    <table class="table table-striped">
                                      ...
                                      if(! empty($skillArray)) {
                                        foreach($skillArray as $ski){ 
                                         echo '<input type="hidden" id="skill_id'.$ski->id.'" value="'.$ski->skills.'" readonly/>';
                                          echo '<input type="hidden" id="experince_id'.$ski->id.'" value="'.$ski->ExperienceInMonths.'" readonly/>';
                                      ?>
                                        <tr class="boxload">
...
<div class="modal fade bs-example-modal-profileedit" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">      
      <form class="form-horizontal" action="<?php echo base_url();?>admin/dashboard/updateProfilepic" method="post" enctype="multipart/form-data">
        <div class="form_pop">
...
function editSkill(skillid){
  var skill = $("#skill_id"+skillid).val();
  var experince = $("#experince_id"+skillid).val();  
  $("#skillid").val(skillid);
...
$("#save8").click(function(){   
  ...
  $.ajax({
    ...
    data: {skillid:skillid,skill:skill,experince:experince},
...
//  $.ajax({
//    type:"POST",
//    url: "<?php echo base_url();?>admin/dashboard/updateProfilepic",

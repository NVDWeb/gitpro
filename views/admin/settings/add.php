...
.service-sub h2{font-weight: 600;
    ...
    padding-bottom: 6px;
    margin-bottom: 20px;}
.service-sub .ego{ float: left;
    background-color: #f0f0f0;
    margin-right: 16px;
    color: #5a5a5a;
    font-weight: bold;
    padding: 7px 15px;}
.service-sub .ego:hover{    background-color: #f68d1f;    color: #fff; text-decoration:none;}
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <div class="x_content">
                            ...
                            <div class="manage_note">Change Password</div>
                            <?php
                           ...
                           <?php if($this->session->userdata('admin_user_type')==2){?>
                            ...
                            <?php 
							if(!empty($getindusries)){
								echo ' <h2>Selected Industries</h2>';
							foreach($getindusries as $industry){
								
								echo '<div class="ego bid01">'.$industry[0]->industry_name.'</div>';
							...
							?>                            
                             ...
                             <div class="inductry_head"><div class="col-md-12"><h2 class="inducsty_hed">Select Industry</h2></div></div>
                            
                            <div class="inductry_drop">
                            
                            <form class ="form-horizontal form-label-left" id="demo-form2" action="<?php echo base_url();?>admin/settings/updateIndustry" method="post">
                         <div class="industry-sub">                           
                            <?php 
							 $industries = $this->industry_model->getParentIndustry();
							if(!empty($industries)){ $i = 0;								
							foreach($industries as $industry){?>						
								<div class="indutry01">
								<input type="checkbox" id="indus<?php echo $industry->id;?>" name="indus[]" value="<?php echo $industry->id;?>"   /> 
                                <label for="indus<?php echo $industry->id;?>"><?php echo $industry->industry_name;?></label>
								</div>
							<?php $i++;}?>
                            	<div class="col-md-4 col-sm-4 col-xs-12">
                                  <label> <br></label>
							...
							foreach($getservices as $service){
								...
								echo '<div class="ego bid01">'.$service[0]->category_name.'</div>';
								//echo '<p>'.$service[0]->category_name.'</p>';
							}
							}
							?>                            
                            ...
                            <div class="profel_hed"><div class="col-md-12"><h2>Select Services</h2></div></div>
                            
                            <div class="profel_hed_drop">
...
$(document).ready(function(){
    $(".inducsty_hed").click(function(){
        $(".inductry_drop").toggle();
    });
});

$(document).ready(function(){
    $(".profel_hed").click(function(){
        $(".profel_hed_drop").toggle();
    });
});

  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
                          ...
                          <div class="profile_form_update edu_update01">
                            ...
                            <div class="row form-group">
                            	<div class="col-md-6 col-sm-6 col-xs-12">
                                	<label class="" for="first-name">Team Name<span class="required">*</span></label>
                                  <div class="text_box_icon"><i class="fa fa-user" aria-hidden="true"></i></div>
                                  <input type="text" id="team_name" name="team_name"  class="" value="<?php echo $team_name;?>">
                                </div>
                              ...
                              <!-- <div class="selectmail form-group" id="selectmail" style="display:none;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                	<label class="" for="first-name">Select Team Category<span class="required">*</span></label>
                                  <div class="text_box_icon"><i class="fa fa-list-ul" aria-hidden="true"></i></div>
		...
		<div class="row form-group">
			<div class="col-md-12 col-sm-12 col-xs-12">
                              	<label class="" for="first-name">Team Profile<span class="required">*</span></label>
                                <div class="text_box_icon"><i class="fa fa-users" aria-hidden="true"></i></div>

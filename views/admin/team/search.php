                          ...
                          <div class="x_panel">
                            ...
                            <div class="profile_form_update edu_update01 lead_box">
                              ...
                              echo form_open_multipart($action='',$attributes); ?>
                                <div class="row form-group" style="border-bottom: 1px solid #ddd; padding-bottom: 11px;">
                                  <div class="col-md-offset-3 col-md-2 col-sm-3 col-xs-12">
                                  	<label class="" for="first-name" style="padding-top: 7px;">CATEGORY <span class="required">*</span></label>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                  	<select name="category" id="category" class="form-control" onChange="getTeam(this.value);" required>
                                ...
                                <table id="datatable" class="table table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    foreach ($getTeamArray as $row) {
                                      ...
                                      if($row->requestedAlready==''){
                                        echo '<tr><td>'.$row->team_name.'</td>';
                                        //echo '<td><a href="javascript:void(0);" class="btn btn-success" onclick="teamJoinRequest('.$row->teamId.','.$this->session->userdata('adminId').')">Join</a></td>
                                        echo '<td><a href="'.base_url().'admin/team/viewteam/'.$row->teamId.'">View</a></td>
                                        </tr>';

          ...
          <div class="row">
            <div class="explor-profes-list01">
              ...
              <div class="explor-profes-list-form">
                ...
                <input type="text" id="nameemail" name="nameemail" value="" placeholder="Search professionals by name or email">
                ...
                <div class="explore_left_side">
                  <div id="open-by-default-example" data-collapse>
                    ...
                    <div>
                        <ul>
                         <?php 
						 $i=1; foreach ($categoryList as $key => $value) { ?>
                          <li>
                            <input id="test<?php echo $i;?>" class="ipchkCategory" value="<?php echo $value->id;?>" name="sport" onClick="selectCat();" type="radio">
                    ...
                    <div>
                        <ul>
                         <?php $i=7; foreach ($subCategoryList as $key => $value) { ?>
                          <li>
                            <input id="test<?php echo $i;?>" class="ipchkCategory" value="<?php echo $value->id;?>" name="sport1" onClick="selectCat();" type="radio">
                            <label for="test<?php echo $i;?>"><?php echo $value->category_name;?></label>
                          </li>
                          <?php $i++;}?>                        
                      </ul>

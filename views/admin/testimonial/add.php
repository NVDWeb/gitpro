          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Testimonial <?php if($testimonial_id){ echo 'Edit'; } else { echo 'Add';} ?></h2>
                    ...
                    <input type="hidden" name="testimonial_id" value="<?php echo $testimonial_id;?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                          <input type="text" id="clinic_name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $name;?>">
                        </div>
                      </div>

              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="<?php echo base_url();?>admin/profiles"><i class="fa fa-user pull-right"></i>Profile</a></li>
...
<div class="admin_header_bottom">
          <div class="main_container01">
            ...
            <?php } ?>
                  ...
                  <?php if($controller=='quotation' || $controller=='projects' || $controller=='leads' && ($method=='view' || $method=='index' || $method=='complete' || $method=='team' || $method=='search')){ 
                      $active = 'active';
                    }else{
                      $active = '';
                    } ?>
              ...
              <?php } ?> -->
                          ...
                          <li><a href="<?php if($this->session->userdata('resume_status') == 1){echo base_url().'admin/projects/team' ; }else {echo '#';}?>" <?php if($this->session->userdata('resume_status') != 1){echo 'onclick="status();"';}?>>Active Team Project </a></li>
                           ...
                           <!--  <li><a href="<?php if($this->session->userdata('resume_status') == 1){echo '#' ; }else {echo '#';}?>" <?php if($this->session->userdata('resume_status') != 1){echo 'onclick="status();"';}?>>Send Proposal </a></li> -->
                            ...
                            <li><a href="<?php if($this->session->userdata('resume_status') == 1){echo base_url().'admin/quotation/search' ; }else {echo '#';}?>" <?php if($this->session->userdata('resume_status') != 1){echo 'onclick="status();"';}?>>Search Project </a></li>

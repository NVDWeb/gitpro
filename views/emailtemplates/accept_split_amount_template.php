...
<body>
	<div class="main01">
        ...
        <div class="content">
            ...
            <p>Congratulations your Team admin assign you a project to work.</p>
            <p>Amount : <?php echo $amount;?></p>
						<p>Proyourway service charge : 7.5 % </p>
						<p>Amount would pay to you is : <?php $t= $amount*7.5;  $ttt = $t/100 ; echo $amount-$ttt.' AUD' ;?></p>
        	<p>Go to your Dashboard and accept/reject it.</p>

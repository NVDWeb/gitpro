...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>Hello Proyourway</h3>
            <p>A professional has Reqested a withdraw : Here are the details</p>
            <p>Professional Name : <?php echo $name;?></p>
            <p>Payable Amount : <?php echo $amount;?></p>
						<p>Payment Mode : <?php echo $payment_mode;?> </p>
						<p>Account details : <?php if($payment_mode=='Paypal') { echo $paypal_email ; }else{ echo $bank_account; } ; ?></p>

...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>New business has just registered</h3>
            <p>A new business has just registered with us.</p>
            <img src="<?php echo base_url();?>assets/common/img/dashbord.jpg" />
            <?php if(isset($business_name)){ ?><p>Business Name : <?php echo  @$business_name;?></p><br/><?php } ?>
            <?php if(isset($business_registration_number)){ ?><p>Business Registration Number : <?php echo  @$business_registration_number;?></p><br/><?php } ?>
            <?php if(isset($contact_person_name)){ ?><p>Contact Person  Name : <?php echo  @$contact_person_name;?></p><br/><?php } ?>
            <?php if(isset($mobile)){ ?><p>Mobile : <?php echo  @$mobile;?></p><br/><?php } ?>
            <?php if(isset($email)){ ?><p>Email : <?php echo  @$email;?></p><br/><?php } ?>
            <?php //if($cat_other){ ?>
            <!--<p>Business is also requested for other category called as <?php //echo $cat_other;?> in <?php //echo $category_name;?></p>-->
            <?php //} ?>

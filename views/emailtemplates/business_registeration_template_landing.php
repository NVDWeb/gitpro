...
<body>
	<div class="main01">
        ...
        <div class="content">
            ...
            <p>Thanks for registering with ProYourWay- an emerging platform for the talented professionals who wants to transparent their services to the businesses using a transparent approach. We aim to connect the Talented Professionals and companies ranging from start-ups to enterprise locally & globally. You are almost on the right track to showcase your talent and visibility with ProYourWay, Follow the Simple steps to get started. We will be launching soon- stay tuned for updates and finding your next client is easier with ProYourWay.</p>
            <!-- <img src="<?php echo base_url();?>assets/common/img/dashbord.jpg" /> -->
            <p>We look forward to help you find your consumers globally. As at ProYourWay, we do not just make profits, we make opportunities.</p>

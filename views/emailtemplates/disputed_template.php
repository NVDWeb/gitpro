...
<body>
	<div class="main01">
        ...
        <div class="content">
            ...
            <p>Milestone Amount : <?php echo $amount;?></p>
            <p>Milestone Name : <?php echo $milestonename;?></p>
			<p>Client Name: <?php echo $clientName;?></p>
            <p>Professional Name: <?php echo $professionalName;?></p>
            <p>Reason : <?php echo $reasonmess;?></p>

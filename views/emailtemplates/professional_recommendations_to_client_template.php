...
<style>
	...
	.mail_star{ width: 100%; height:auto; float: left;     margin-bottom: 20px; }
	.mail_star ul{width: 100%; height:auto; float: left; margin: 0px; padding: 0px; list-style: none;}
	.mail_star ul li{width: 100%; height:auto; float: left;     font-size: 13px;    margin-bottom: 8px;}
	.mail_star ul li b{    width: 65px;
    float: left;
    border-right: 1px solid rgba(221, 221, 221, 0.65);
    margin-right: 20px;}
	.mail_star ul li span{}
	.mail_star ul li span img{     max-width: 14px;    vertical-align: bottom;}
	...
	<div class="main01">
        ...
        <div class="content">
        	<h3>Dear Client,</h3>
					...
					<p>Your business has led you to us and we have made it our main priority to offer you what you are looking for.</p>
					<p>We have the right professionals for you who are experts in what they do and will finish your project the way you want.</p>
					<p>Explore the pool to find the right professional.</p>
					<p>So, take some time and go through the profiles of each expert and prefer the best one perfect for your project.</p>
					<p>You are just a step away to get your job done.</p>
					<p>For further assistance contact us at <a href="mailto:services@proyourway.com">services@proyourway.com</a> and get social with us! (Hyperlink)</p>
					<p>Our top 5 Recommendations : </p>
					<div class="mail_star">
						<ul>
							<?php foreach($list as $row){ ?>
							<li><b>Name</b>  <?php echo $row->first_name;?> <span><?php for($i=1 ; $i<=$row->MaxRating; $i++){ ?><img src="https://www.proyourway.com/beta/assets/common/images/star-mail.png"><?php } ?></span></li>
							<?php } ?>
							
						</ul>
					</div>
					<?php //echo '<pre>';print_r($list);?>
                      <b>Note: Your Post has not been  verified by ProYourWay Team </b>

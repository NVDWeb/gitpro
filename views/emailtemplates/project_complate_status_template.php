...
<body>
	<div class="main01">
        ...
        <div class="content">
            ...
            <p>Project Staus Message : <?php echo $message;?></p>
            <?php if(!empty($proName)){?>
            <p>Professional Name : <?php echo $proName;?></p>
            <?php }?>
             <?php if(!empty($proemail)){?>
              <p>Professional Email : <?php echo $proemail;?></p>
             <?php }?>
             <?php if(!empty($clientname)){?>
            <p>Client Name : <?php echo $clientname;?></p>
            <?php }?>

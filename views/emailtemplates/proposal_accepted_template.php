...
<body>
	<div class="main01">
        ...
        <div class="content">
        	...
        	<?php if(!empty($shortnote)){
    			echo 'Short Note: <p>'.$shortnote.'</p>';
            }?>
            <p>Your proposal for the job is accepted by the client</p>
						<p><a href="<?php echo base_url();?>login">Please login to check</a></p>

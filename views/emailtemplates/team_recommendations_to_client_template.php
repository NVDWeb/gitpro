	...
	<div class="main01">
        ...
        <div class="content">
        	<h3>Dear <?php echo $client_name;?>,</h3>            
					...
					<p>We have the right team of professionals for you who are experts in what they do and will finish your project the way you want.</p>
					...
					<?php //echo '<pre>';print_r($teamList);?>
						<table>
							...
							<?php foreach ($teamList as $value) { ?>
								<tr>
									<td><?php echo $value->teamAdminName;?></td>
									<td><?php echo $value->team_name;?></td>
									<td><?php echo $value->maxRating;?></td>
								</tr>
							<?php } ?>
						</table>

...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>Hi </h3>
            <p><?php if($type=='succ') { echo 'Congratulations';}else{ echo 'Soory'; } ?> ! <?php echo $member_name;?> has just <?php if($type=='succ') { echo 'Joined your team.'; } else { echo 'Reject you team request.';} ?></p>
      			<p><a href="<?php echo base_url();?>/login">click here</a> to see</p>

	...
	<div class="main01">
        ...
        <div class="content">
            ...
            <p>Thank You for getting in touch with us.</p>
						<p>Follow the link below if you wish to reset your password.</p>
						<p><a href="<?php echo base_url();?>admin/index/reset_password/<?php echo $password;?>/<?php echo $role;?>">Click here to update password</p>
            <p>Please ignore if you haven’t requested a password change.</p>
            <p>Change your password and start a secured journey with ProYourWay where a sea of opportunities is waiting for you.</p>

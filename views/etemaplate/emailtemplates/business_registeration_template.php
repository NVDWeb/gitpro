...
<body>
	<div class="main01">
        ...
        <div class="content">
        	...
        	<h3>Welcome to ProYourWay</h3>
            <p>Thanks for registering With ProYourWay.</p>
						<p>We offer an accessible working plateau to Individuals, Companies and Government Organizations with exceptional services in the field of Accountancy/ Financial Advisory, Lawyers & Solicitors, Consultancy, Marketing, IT & Web Service, Human Resources etc.</p>
            <!-- <img src="<?php echo base_url();?>assets/common/img/dashbord.jpg" /> -->
            <p>We know your time is valuable and we appreciate your effort in showing interest. We are on our early-boarding stage. Your application is under review and you will get notified within next 48 hours and one of our representatives will be getting in touch with you shortly.</p>
						<p>We love to serve our clients a little better than their expectations, just like you.</p>
						<p>Trust us; your career path is going to get a whole lot interesting!</p>
						<!--<p>Please click this link to verify your Email address <a href="<?php echo base_url();?>business/verify/<?php echo $randomString;?>" target="_blank">Verify Your Email</a></p>-->

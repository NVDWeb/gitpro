...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>Hi</h3>
            <p>We got a new Project Lead for you.</p>
            <img src="<?php echo base_url();?>assets/common/img/dashbord.jpg" />
            <p><a href="<?php echo base_url();?>login">View Project</a></p>
            <h5>Project details</h5>
      			<p>Client Name : <?php echo 'Ashraf ali';?></p>
      			<p>Project Category : <?php echo '<a href="">'.$category.'</a>';?></p>
      			<p>Project Details: <?php echo $project_details;?></p>

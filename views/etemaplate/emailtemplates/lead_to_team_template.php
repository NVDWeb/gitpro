...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>Dear Connoisseur,</h3>
					<p>Greeting from ProYourWay!</p>
					<p>Your inbox has received various opportunities for you from various business units.</p>
					<p>Here is the ultimate chance for your team to grow and stand out from other professionals with the same expertise. Here is the <strong>list of projects that are awaiting your response</strong>. Grab the opportunity that knocked on your door & don’t let them wait for too long!</p>

...
<body>
	<div class="main01">
        ...
        <div class="content">
        	...
        	<p>Heartfelt Congratulations to <?php echo $first_name;?></p>
            <p>We are thrilled to announce that your application passed successfully through our filtration process and now you are a part of Team ProYourWay.</p>
						<p style="color:blue">We are delighted to have you onboard with us!</p>
            <!-- <img src="<?php echo base_url();?>assets/common/img/dashbord.jpg" /> -->
            <p>With much expertise and knowledge in the practical work play, talented professionals are presented with a higher platform that acts as a footstool in their career path and helping them climb up to the next level!.</p>
						<p>Follow the simple procedure and get started-</p>
						<p>Apply for the projects (hyperlink), send proposals, collaborate and get paid.</p>
						<p>We believe in real time connectivity and fluidity for which distinctive features like Live audio/video chat, co-browsing and online negotiation tool are designed to provide our esteemed professionals like you with efficient and virtual workspace.</p>
						<p>Apply for projects, send proposals and negotiate until satisfied!</p>
						<p>What are you waiting for, Log on to- <a href="<?php echo base_url();?>">www.proyourway.com</a> and get started. </p>

...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>Hi</h3>
					<?php if($type=='team_lead') {?>
            <p>A new Lead has submitted for One of your team</p>
					<?php }else{ ?>
						<p>A new Lead has submitted for you</p>
					<?php} ?>
						<p>You can see all your Team Project in your dashboard <a href="<?php echo base_url();?>login" target="_blank">Click here to login</a></p>

...
<body>
	<div class="main01">
        ...
        <div class="content">
        	<h3>Hi</h3>
            <p>Some one wants you to join the team.</p>
      			<p>Team Owner Name : <?php echo 'Ashraf ali';?></p>
    		    <p>If you want to be part of this team <a href="<?php echo base_url();?>team/join/<?php echo base64_encode($email);?>/<?php echo $token_value;?>">click here</a> to join</p>
